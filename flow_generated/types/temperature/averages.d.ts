...
import { Document as FromReadingsSource } from './readings';
export { Document as FromReadingsSource } from './readings';
...
import { Document as FromSensorsSource } from './sensors';
export { Document as FromSensorsSource } from './sensors';
...
export interface IDerivation {
    fromReadingsPublish(source: FromReadingsSource, register: Register, previous: Register): Document[];
    fromSensorsPublish(source: FromSensorsSource, register: Register, previous: Register): Document[];
}
