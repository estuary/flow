...
Data flows have three required components:
...
A catalog can be represented as a graph of your data flow. At minimum, a catalog must have one capture, one collection, and one materialization.
