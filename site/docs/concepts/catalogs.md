...
## Data Flow specification files

Catalog entities are defined and described in Data Flow **specification files.**
...
Using this extension activates Estuary's VS Code integration and auto-complete.
Estuary integrates with VS Code for development environment support, like auto-complete,
...
prefixes and every name within Estuary is globally unique.
...
As an Estuary customer, you're provisioned one or more high-level prefixes for your organization.
Further division of the namespace into prefixes is up to you.

Prefixes of the namespace, like `acmeCo/teams/manufacturing/`,
are the foundation for Estuary's [authorization model](/reference/authentication).
