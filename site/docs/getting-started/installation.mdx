...
3. Add Estuary's Azure application to your tenant. When you finish, you will be redirected back to these docs.
...
```
https://login.microsoftonline.com/<YOUR_AZURE_TENANT>/oauth2/authorize?client_id=42cb0c6c-dab0-411f-9c21-16d5a2b1b025&response_type=code&redirect_uri=https://docs.estuary.dev/getting-started/installation/#azure-blob-storage&resource_id=https://storage.azure.com
```
