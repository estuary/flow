...
New Estuary accounts are connected to Estuary's secure cloud storage bucket to store collection data.
...
You'll need to grant Estuary access to your GCS bucket.

1. [Create a bucket to use with Estuary](https://cloud.google.com/storage/docs/creating-buckets), if you haven't already.
...
You'll need to grant Estuary access to your S3 bucket.

1. [Create a bucket to use with Estuary](https://docs.aws.amazon.com/AmazonS3/latest/userguide/create-bucket-overview.html),
...
You'll need to grant Estuary access to your storage account and container.
...
2. Within the storage account, [create an Azure Blob Storage container](https://learn.microsoft.com/en-us/azure/storage/blobs/storage-quickstart-blobs-portal#create-a-container)
   to use with Estuary, if you haven't already.
...
3. Gather the following information. You'll need this when you contact us to complete setup.
   ...
   You'll grant Estuary access to your storage resources by connecting to Estuary's
...
Let us know whether you want to use this storage bucket for your whole Estuary account, or just a
