---
description: Build a stateless Python transformation in Estuary using flowctl and demo Wikipedia data. Covers spec files, transformation code, and publishing steps.
