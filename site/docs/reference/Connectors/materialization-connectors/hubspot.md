...
searches HubSpot for records using a property value from the document.
...
You can search for existing unique properties in the HubSpot webapp: `Settings
/ Data Management / Properties` and check if the property rules require unique
values.
