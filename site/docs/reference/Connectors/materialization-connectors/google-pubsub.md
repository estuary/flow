...
* Access to the project. Different items are required to configure access [using OAuth in the Estuary web app](#oauth-authentication-using-the-estuary-web-app) (recommended),
...
OAuth is the simplest authentication method, and is supported in the Estuary web app. You'll need:
...
Use the below properties to configure a Google Cloud Pub/Sub materialization, which will direct one or more of your Estuary collections to your desired Pub/Sub topics.
...
You can materialize multiple Estuary collections to the same Pub/Sub topic. This is known as a **multiplex topic**.
...
* Each binding pulls from a different Estuary collection
...
This connector sets the ordering key of published messages using the Estuary [collection key](../../../concepts/collections.md#keys)
