...
this function, the next_auto_discovers view will no longer include that capture until it's interval has passed again.
So it's safe to call this function at basically any frequency. The return value of the function is the count of newly
