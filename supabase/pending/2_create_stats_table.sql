--
-- This is copied almost verbatim from 11_stats.sql, with the inclusion of a transaction and the
-- omission of creating the "grain" type since it will already exist.
--
-- Run this only after 1_single_ops_collection.sql & its publication is complete.
--
