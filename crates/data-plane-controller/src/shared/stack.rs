...
pub struct State {
    ...
    // When Some, per-link results observed at `PulumiUp1`, to be written into
    // `data_plane_private_links` ahead of the end-of-converge write. See
    // `write_private_link_statuses` for which columns the early write sets.
