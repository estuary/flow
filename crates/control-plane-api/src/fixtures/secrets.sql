...
insert into internal.secrets (catalog_name, id, document) values (
  ...
  '4444444444444444',
  '{"name":"acmeVendor/oauth/ghcr.io/acmeVendor/source-widgets/oauth-client","value":"ENC[AES256_GCM,data:b3NwcmV5,type:str]","sops":{"lastmodified":"2026-01-15T01:29:57Z","mac":"ENC[AES256_GCM,data:bWFj]","encrypted_regex":"^value$","version":"3.11.0"}}'
);
