...
begin
  ...
  insert into public.live_specs (id, controller_task_id, catalog_name, last_pub_id, spec_type, spec, built_spec, data_plane_id) values
    ...
    (materialize_bar_id, materialize_bar_id, 'aliceCo/out/materialize-bar', last_pub_id, 'materialization', '{}', '{"shardTemplate":{"id":"materialize/aliceCo/out/materialize-bar/gen9012"}}', data_plane_one_id)
  ;
