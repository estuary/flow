...
// TODO(johnny): Refactor this route onto
// `task_residency::resolve_catalog_task_location`, mapping `Elsewhere` to the
// existing redirect response while keeping Dekaf-specific type and ops checks.
