...
use crate::testing::{TestApp, publish_utils::draft_catalog};
...
pub async fn common_setup(pg_pool: sqlx::PgPool) -> (TestApp, Uuid, Uuid) {
    let mut harness = TestApp::new(pg_pool);
    ...
    assert_eq!(
        ...
        crate::publications::StatusType::Success
    );
