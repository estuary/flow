...
//! its user. The masked *refusal* guarding this loop (`createRefreshToken`)
//! is pinned in that surface's own module and deliberately not repeated
...
/// the exchanged access token, minted by the SQL path and carrying no
