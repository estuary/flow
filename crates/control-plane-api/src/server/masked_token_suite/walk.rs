...
/// pre-check refusal naming the withheld bits and the target, and nothing
/// about grants — the `empty` row
...
async fn test_no_amplification_sweep(pool: sqlx::PgPool) {
    ...
    let all_bundles: Vec<&str> = <models::authz::CapabilityBundle as strum::VariantArray>::VARIANTS
        .iter()
        .map(|b| b.name())
        .collect();
    ...
    empty:
      danaCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'danaCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
      sharedCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'sharedCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
      wideCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'wideCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
      otherCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'otherCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
    unknown-only:
      danaCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'danaCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
      sharedCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'sharedCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
      wideCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'wideCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
      otherCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'otherCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
    CatalogRead:
      danaCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'danaCo/data/collection'","missing_capabilities":["JournalRead","ViewDataPlanePrivateNetworking"]}
      sharedCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'sharedCo/data/collection'","missing_capabilities":["JournalRead","ViewDataPlanePrivateNetworking"]}
      wideCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'wideCo/data/collection'","missing_capabilities":["JournalRead","ViewDataPlanePrivateNetworking"]}
      otherCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'otherCo/data/collection'","missing_capabilities":["JournalRead","ViewDataPlanePrivateNetworking"]}
    Delegate:
      danaCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'danaCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
      sharedCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'sharedCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
      wideCo/data/collection => 403 {"error":"missing_capabilities","message":"token does not enable capabilities [CatalogRead, JournalRead, ViewDataPlanePrivateNetworking] required to access prefix or name 'wideCo/data/collection'","missing_capabilities":["CatalogRead","JournalRead","ViewDataPlanePrivateNetworking"]}
...
/// minted `["Viewer"]` mask the walk stops at danaCo/ (the mask withholds
/// `Delegate`, so the role edge is never traversed) and the same ref
/// presents as inaccessible: `userCapability` null and gated fields null
