...
tables!(
    ...
    table BuiltCaptures (row BuiltCapture, sql "built_captures") {
        ...
        val scope: url::Url,
        // Control-plane ID of this capture, if assigned.
        val control_id: Option<models::Id>,
        // Data-plane assignment for this capture.
        val data_plane_id: models::Id,
    ...
    table BuiltCollections (row BuiltCollection, sql "built_collections") {
        ...
        val scope: url::Url,
        // Control-plane ID of this collection, if assigned.
        val control_id: Option<models::Id>,
        // Data-plane assignment for this collection.
        val data_plane_id: models::Id,
        // Expected last publication ID for optimistic concurrency.
    ...
    table BuiltMaterializations (row BuiltMaterialization, sql "built_materializations") {
        ...
        val scope: url::Url,
        // Control-plane ID of this materialization, if assigned.
        val control_id: Option<models::Id>,
        // Data-plane assignment for this materialization.
        val data_plane_id: models::Id,
        // Expected last publication ID for optimistic concurrency.
    ...
    table BuiltTests (row BuiltTest, sql "built_tests") {
        ...
        val scope: url::Url,
        // Control-plane identifier for this test, if assigned.
        val control_id: Option<models::Id>,
        // Expected last publication ID for optimistic concurrency.
        val expect_pub_id: models::Id,
        // Model of the test, or None if the test is being deleted.
    ...
    table MetaTable (row Meta, sql "meta") {
        ...
        val default_data_plane_id: Option<models::Id>,
        // Default data-plane name for created specifications.
        val default_data_plane_name: String,
        // Should the catalog build fail-fast?
        val fail_fast: bool,
        // Project root for the build.
