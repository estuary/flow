...
pub fn rkyv_types() {
    ...
    let nodes = [
        doc::HeapNode::Array(1, doc::BumpVec::new()),
        doc::HeapNode::Array(3, doc::BumpVec::with_contents(
            &alloc,
        ...
        doc::HeapNode::Null,
        doc::HeapNode::Object(1, doc::BumpVec::new()),
        doc::HeapNode::Object(3, doc::BumpVec::with_contents(
            &alloc,
            [
                doc::HeapField {
