...
impl serde::Serialize for build_api::Code {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        let variant = match self {
            ...
            Self::TrampolineFetch => "TRAMPOLINE_FETCH",
            Self::TrampolineValidateCapture => "TRAMPOLINE_VALIDATE_CAPTURE",
            Self::TrampolineValidateMaterialization => "TRAMPOLINE_VALIDATE_MATERIALIZATION",
            Self::Done => "DONE",
            Self::DoneWithErrors => "DONE_WITH_ERRORS",
            Self::TrampolineDockerInspect => "TRAMPOLINE_DOCKER_INSPECT",
            Self::CatalogSchema => "CATALOG_SCHEMA",
        };
        serializer.serialize_str(variant)
    }
}
impl<'de> serde::Deserialize<'de> for build_api::Code {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            ...
            "TRAMPOLINE",
            "TRAMPOLINE_FETCH",
            "TRAMPOLINE_VALIDATE_CAPTURE",
            "TRAMPOLINE_VALIDATE_MATERIALIZATION",
            "DONE",
            "DONE_WITH_ERRORS",
            "TRAMPOLINE_DOCKER_INSPECT",
            "CATALOG_SCHEMA",
        ];
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                ...
                i32::try_from(v)
                    .ok()
                    .and_then(build_api::Code::from_i32)
                    .ok_or_else(|| {
            ...
            {
                match value {
                    "BEGIN" => Ok(build_api::Code::Begin),
                    "POLL" => Ok(build_api::Code::Poll),
                    "TRAMPOLINE" => Ok(build_api::Code::Trampoline),
                    "TRAMPOLINE_FETCH" => Ok(build_api::Code::TrampolineFetch),
                    "TRAMPOLINE_VALIDATE_CAPTURE" => Ok(build_api::Code::TrampolineValidateCapture),
                    "TRAMPOLINE_VALIDATE_MATERIALIZATION" => Ok(build_api::Code::TrampolineValidateMaterialization),
                    "DONE" => Ok(build_api::Code::Done),
                    "DONE_WITH_ERRORS" => Ok(build_api::Code::DoneWithErrors),
                    "TRAMPOLINE_DOCKER_INSPECT" => Ok(build_api::Code::TrampolineDockerInspect),
                    "CATALOG_SCHEMA" => Ok(build_api::Code::CatalogSchema),
...
impl serde::Serialize for build_api::Fetch {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("flow.BuildAPI.Fetch", len)?;
        if !self.resource_url.is_empty() {
            struct_ser.serialize_field("resourceUrl", &self.resource_url)?;
        }
        if self.content_type != 0 {
            let v = ContentType::from_i32(self.content_type)
                .ok_or_else(|| serde::ser::Error::custom(format!("Invalid variant {}", self.content_type)))?;
            struct_ser.serialize_field("contentType", &v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for build_api::Fetch {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "resourceUrl" | "resource_url" => Ok(GeneratedField::ResourceUrl),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = build_api::Fetch;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct flow.BuildAPI.Fetch")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<build_api::Fetch, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut resource_url__ = None;
                let mut content_type__ = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::ResourceUrl => {
                            if resource_url__.is_some() {
                                return Err(serde::de::Error::duplicate_field("resourceUrl"));
                            }
                            resource_url__ = Some(map.next_value()?);
                        }
                        GeneratedField::ContentType => {
                            if content_type__.is_some() {
                                return Err(serde::de::Error::duplicate_field("contentType"));
                            }
                            content_type__ = Some(map.next_value::<ContentType>()? as i32);
                        }
                    }
                }
                Ok(build_api::Fetch {
                    resource_url: resource_url__.unwrap_or_default(),
                    content_type: content_type__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("flow.BuildAPI.Fetch", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for JournalShuffle {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("flow.JournalShuffle", len)?;
        if !self.journal.is_empty() {
...
impl<'de> serde::Deserialize<'de> for JournalShuffle {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = JournalShuffle;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct flow.JournalShuffle")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<JournalShuffle, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("flow.JournalShuffle", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Shuffle {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.source_partitions.is_some() {
            len += 1;
        }
        if !self.source_uuid_ptr.is_empty() {
            len += 1;
        }
        if !self.shuffle_key_ptrs.is_empty() {
            len += 1;
        }
        if !self.shuffle_key_partition_fields.is_empty() {
            len += 1;
        }
        if self.uses_source_key {
            len += 1;
        }
        ...
        if !self.validate_schema.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("flow.Shuffle", len)?;
        if !self.group_name.is_empty() {
            struct_ser.serialize_field("groupName", &self.group_name)?;
        }
        if !self.source_collection.is_empty() {
            struct_ser.serialize_field("sourceCollection", &self.source_collection)?;
        }
        if let Some(v) = self.source_partitions.as_ref() {
            struct_ser.serialize_field("sourcePartitions", v)?;
        }
        if !self.source_uuid_ptr.is_empty() {
            struct_ser.serialize_field("sourceUuidPtr", &self.source_uuid_ptr)?;
        }
        if !self.shuffle_key_ptrs.is_empty() {
            struct_ser.serialize_field("shuffleKeyPtrs", &self.shuffle_key_ptrs)?;
        }
        if !self.shuffle_key_partition_fields.is_empty() {
            struct_ser.serialize_field("shuffleKeyPartitionFields", &self.shuffle_key_partition_fields)?;
        }
        if self.uses_source_key {
            struct_ser.serialize_field("usesSourceKey", &self.uses_source_key)?;
        }
        if self.filter_r_clocks {
            struct_ser.serialize_field("filterRClocks", &self.filter_r_clocks)?;
        }
        if self.read_delay_seconds != 0 {
            struct_ser.serialize_field("readDelaySeconds", &self.read_delay_seconds)?;
        }
        ...
        if !self.validate_schema.is_empty() {
            struct_ser.serialize_field("validateSchema", &self.validate_schema)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Shuffle {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "groupName" | "group_name" => Ok(GeneratedField::GroupName),
                            "sourceCollection" | "source_collection" => Ok(GeneratedField::SourceCollection),
                            "sourcePartitions" | "source_partitions" => Ok(GeneratedField::SourcePartitions),
                            "sourceUuidPtr" | "source_uuid_ptr" => Ok(GeneratedField::SourceUuidPtr),
                            "shuffleKeyPtrs" | "shuffle_key_ptrs" => Ok(GeneratedField::ShuffleKeyPtrs),
                            "shuffleKeyPartitionFields" | "shuffle_key_partition_fields" => Ok(GeneratedField::ShuffleKeyPartitionFields),
                            "usesSourceKey" | "uses_source_key" => Ok(GeneratedField::UsesSourceKey),
                            "filterRClocks" | "filter_r_clocks" => Ok(GeneratedField::FilterRClocks),
                            "readDelaySeconds" | "read_delay_seconds" => Ok(GeneratedField::ReadDelaySeconds),
                            "priority" => Ok(GeneratedField::Priority),
                            "validateSchema" | "validate_schema" => Ok(GeneratedField::ValidateSchema),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct flow.Shuffle")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<Shuffle, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut group_name__ = None;
                let mut source_collection__ = None;
                let mut source_partitions__ = None;
                let mut source_uuid_ptr__ = None;
                let mut shuffle_key_ptrs__ = None;
                let mut shuffle_key_partition_fields__ = None;
                let mut uses_source_key__ = None;
                let mut filter_r_clocks__ = None;
                let mut read_delay_seconds__ = None;
                let mut priority__ = None;
                let mut validate_schema__ = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::GroupName => {
                            if group_name__.is_some() {
                        ...
                        GeneratedField::SourceCollection => {
                            if source_collection__.is_some() {
                                return Err(serde::de::Error::duplicate_field("sourceCollection"));
                            }
                            source_collection__ = Some(map.next_value()?);
                        }
                        GeneratedField::SourcePartitions => {
                            if source_partitions__.is_some() {
                                return Err(serde::de::Error::duplicate_field("sourcePartitions"));
                            }
                            source_partitions__ = map.next_value()?;
                        }
                        GeneratedField::SourceUuidPtr => {
                            if source_uuid_ptr__.is_some() {
                                return Err(serde::de::Error::duplicate_field("sourceUuidPtr"));
                            }
                            source_uuid_ptr__ = Some(map.next_value()?);
                        }
                        GeneratedField::ShuffleKeyPtrs => {
                            if shuffle_key_ptrs__.is_some() {
                                return Err(serde::de::Error::duplicate_field("shuffleKeyPtrs"));
                            }
                            shuffle_key_ptrs__ = Some(map.next_value()?);
                        }
                        GeneratedField::ShuffleKeyPartitionFields => {
                            if shuffle_key_partition_fields__.is_some() {
                                return Err(serde::de::Error::duplicate_field("shuffleKeyPartitionFields"));
                            }
                            shuffle_key_partition_fields__ = Some(map.next_value()?);
                        }
                        GeneratedField::UsesSourceKey => {
                            if uses_source_key__.is_some() {
                                return Err(serde::de::Error::duplicate_field("usesSourceKey"));
                            }
                            uses_source_key__ = Some(map.next_value()?);
                        }
                        GeneratedField::FilterRClocks => {
                            if filter_r_clocks__.is_some() {
                                return Err(serde::de::Error::duplicate_field("filterRClocks"));
                            }
                            filter_r_clocks__ = Some(map.next_value()?);
                        }
                        GeneratedField::ReadDelaySeconds => {
                            if read_delay_seconds__.is_some() {
                                return Err(serde::de::Error::duplicate_field("readDelaySeconds"));
                        ...
                        GeneratedField::ValidateSchema => {
                            if validate_schema__.is_some() {
                                return Err(serde::de::Error::duplicate_field("validateSchema"));
                            }
                            validate_schema__ = Some(map.next_value()?);
                        }
                    }
                }
                Ok(Shuffle {
                    group_name: group_name__.unwrap_or_default(),
                    source_collection: source_collection__.unwrap_or_default(),
                    source_partitions: source_partitions__,
                    source_uuid_ptr: source_uuid_ptr__.unwrap_or_default(),
                    shuffle_key_ptrs: shuffle_key_ptrs__.unwrap_or_default(),
                    shuffle_key_partition_fields: shuffle_key_partition_fields__.unwrap_or_default(),
                    uses_source_key: uses_source_key__.unwrap_or_default(),
                    filter_r_clocks: filter_r_clocks__.unwrap_or_default(),
                    read_delay_seconds: read_delay_seconds__.unwrap_or_default(),
                    priority: priority__.unwrap_or_default(),
                    validate_schema: validate_schema__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("flow.Shuffle", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ShuffleRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("flow.ShuffleRequest", len)?;
        if let Some(v) = self.shuffle.as_ref() {
            struct_ser.serialize_field("shuffle", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for ShuffleRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct flow.ShuffleRequest")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ShuffleRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut shuffle__ = None;
        ...
        deserializer.deserialize_struct("flow.ShuffleRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ShuffleResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("flow.ShuffleResponse", len)?;
        if self.status != 0 {
            let v = super::consumer::Status::from_i32(self.status)
...
impl<'de> serde::Deserialize<'de> for ShuffleResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct flow.ShuffleResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ShuffleResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::Status => {
                            ...
                            status__ = Some(map.next_value::<super::consumer::Status>()? as i32);
                        }
                        ...
                        GeneratedField::TerminalError => {
                            ...
                            terminal_error__ = Some(map.next_value()?);
                        }
        ...
        deserializer.deserialize_struct("flow.ShuffleResponse", FIELDS, GeneratedVisitor)
    }
}
