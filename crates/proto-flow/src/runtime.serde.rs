...
impl serde::Serialize for TaskServiceConfig {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.config_encryption_url.is_empty() {
            len += 1;
        }
        ...
        if !self.config_encryption_url.is_empty() {
            struct_ser.serialize_field("configEncryptionUrl", &self.config_encryption_url)?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "configEncryptionUrl" | "config_encryption_url" => Ok(GeneratedField::ConfigEncryptionUrl),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut config_encryption_url__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ConfigEncryptionUrl => {
                            if config_encryption_url__.is_some() {
                                return Err(serde::de::Error::duplicate_field("configEncryptionUrl"));
                            }
                            config_encryption_url__ = Some(map_.next_value()?);
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                        }
                ...
                Ok(TaskServiceConfig {
                    ...
                    config_encryption_url: config_encryption_url__.unwrap_or_default(),
                })
            }
        }
