...
pub struct Shuffle {
    ...
    pub source_partitions: ::core::option::Option<
    ...
    pub shuffle_key_partition_fields: ::prost::alloc::vec::Vec<
    ...
    /// TODO(johnny): Figure out how this will actually work.
    ...
    #[prost(string, tag = "14")]
    pub validate_schema: ::prost::alloc::string::String,
}
...
pub struct ShuffleResponse {
    ...
    /// media-type.
    #[prost(message, repeated, tag = "7")]
    pub docs: ::prost::alloc::vec::Vec<Slice>,
...
pub mod combine_api {
    ...
    pub struct Config {
        ...
        #[prost(string, repeated, tag = "3")]
        pub field_ptrs: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
        /// JSON-Pointer at which the UUID for each document will live.
        #[prost(string, tag = "5")]
        pub uuid_ptr: ::prost::alloc::string::String,
        /// Whether or not to inject a placeholder into each document at `uuid_ptr`
        #[prost(bool, tag = "6")]
        pub inject_uuid_placeholder: bool,
    }
