...
impl DekafTestEnv {
    ...
    pub fn connection_info(&self) -> ConnectionInfo {
        ConnectionInfo {
            broker: std::env::var("DEKAF_BROKER").expect("DEKAF_BROKER must be set for e2e tests"),
            registry: std::env::var("DEKAF_REGISTRY")
                .expect("DEKAF_REGISTRY must be set for e2e tests"),
