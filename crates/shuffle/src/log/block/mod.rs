...
pub struct BlockMeta {
    ...
    pub producer_bid: u16,
    /// Publication flags of this document, matching `slice::read::Meta::flags`.
    /// Bits 0-9: UUID transaction flags (OUTSIDE_TXN, CONTINUE_TXN, etc.).
    /// Bit 15 (`FLAGS_SCHEMA_VALID = 0x8000`): document passed JSON Schema validation.
    pub flags: u16,
...
fn encode_entries(
    ...
    for (block_meta, source_byte_length, packed_key, doc_bytes) in entries {
