...
lazy_static::lazy_static! {
    ...
    static ref ISO_8601_DURATION_RE: Regex = Regex::new(r"^P(?:\d+(?:\.\d+)?W|(?:(?:\d+(?:\.\d+)?Y(?:\d+(?:\.\d+)?M)?(?:\d+(?:\.\d+)?D)?|\d+(?:\.\d+)?M(?:\d+(?:\.\d+)?D)?|\d+(?:\.\d+)?D)(?:T(?:\d+(?:\.\d+)?H(?:\d+(?:\.\d+)?M)?(?:\d+(?:\.\d+)?S)?|\d+(?:\.\d+)?M(?:\d+(?:\.\d+)?S)?|\d+(?:\.\d+)?S))?)|T(?:\d+(?:\.\d+)?H(?:\d+(?:\.\d+)?M)?(?:\d+(?:\.\d+)?S)?|\d+(?:\.\d+)?M(?:\d+(?:\.\d+)?S)?|\d+(?:\.\d+)?S))$").expect("Is a valid regex");
...
mod test {
    ...
    fn test_format_cases() {
        ...
        for (format, value, expect) in [
            ...
            ("duration", "PT45S", true),
            ("duration", "PT0.75H", true),
            ("duration", "P3DT4H30M5.75S", true), // Fractional seconds.
            ("duration", "PT1.5H2.25M", true),
            ("duration", "PT0.5S", true),
            ("duration", "PT1H30.5S", true),
            ("duration", "PT2M3.75S", true),
