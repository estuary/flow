...
pub enum Outcome<'s, A: Annotation> {
    ...
    MinimumNotMet,
    MissingRequiredProperty(&'s schema::FrozenString),
    MultipleOfNotMet,
    NotIsValid,
    ...
    ReferenceNotFound(&'s schema::FrozenString),
...
pub struct ScopedOutcome<'s, A: Annotation> {
    ...
    pub schema_curi: &'s schema::FrozenString,
    pub tape_index: i32,
}
    ...
    A: Annotation,
{
    ...
    outcomes_unevaluated: Vec<(u32, i32, &'s schema::FrozenString, Outcome<'s, A>)>,
}
