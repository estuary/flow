...
impl Table {
    ...
    ///
    /// Uniform on purpose. These names are generated by the harness and cannot contain a quote
    /// today, but one site escaped and five interpolated raw — which reads as if the five had
    /// been audited and found safe, when they had not been. One spelling means there is nothing
    /// to audit.
