...
impl State {
    ...
    pub fn drain_chunk(
        ...
        let more = drainer.drain_while(|doc, _fully_reduced| {
            ...
            let key_packed = crate::extract_packed(
                &doc,
            ...
            let partitions_packed =
                crate::extract_packed(&doc, &self.partitions, &self.document_shape, &mut buf);
