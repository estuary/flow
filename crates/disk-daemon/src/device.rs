...
//!
//! This is the daemon side of a disk, and exactly the device's life: add, set
//! parameters, hand the queue to an owner, start — then stop, release, delete.
...
impl Device {
    ...
    /// image left open: the disk resumes it rather than opening one of its own
    /// over whatever it now finds allocated.
    ///
    ...
    fn serve(
        ...
        let owner = owner::spawn(owner::Inputs {
            dev_id,
            cdev,
            image,
            capture,
