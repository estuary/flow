...
//!
//! This is the document half of preview's output. The observation half —
//! connector-state updates (`--output-state`) and Apply actions
...
/// gating lives on the preview [`Logger`](super::logger::PreviewLogger)).
#[derive(Clone)]
