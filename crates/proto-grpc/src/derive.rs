...
pub mod connector_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn derive(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = ::proto_flow::derive::Request>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("derive.Connector", "Derive"));
                ...
                "/derive.Connector/Derive" => {
                        ...
                        for DeriveSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut =
                                async move { <T as Connector>::derive(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
