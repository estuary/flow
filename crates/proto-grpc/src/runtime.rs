...
pub mod task_control_client {
    ...
    ///
    /// Only the runtime-next sidecar serves TaskControl over gRPC. Users reach it
    /// through the reactor front door, which relays to that sidecar but exposes
    /// itself as HTTP/NDJSON rather than gRPC — see go/runtime/task_control_http.go.
    #[derive(Debug, Clone)]
