...
pub mod connector_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn capture(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = ::proto_flow::capture::Request>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/capture.Connector/Capture");
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("capture.Connector", "Capture"));
...
pub mod connector_server {
    ...
    pub trait Connector: std::marker::Send + std::marker::Sync + 'static {
        ...
        type CaptureStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<::proto_flow::capture::Response, tonic::Status>,
            > + std::marker::Send
            + 'static;
        async fn capture(
            &self,
                ...
                "/capture.Connector/Capture" => {
                        ...
                        for CaptureSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut =
                                async move { <T as Connector>::capture(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "capture.Connector";
