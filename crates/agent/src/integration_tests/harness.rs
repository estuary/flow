...
impl TestHarness {
    ...
    /// tables should all look just like they would in production. Note that
    /// this includes the seeded tenant-prefix DataMovementStalled config;
    /// tests exercising unconfigured-alert paths must delete that row.
