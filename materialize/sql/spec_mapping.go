...
func TableForMaterialization(name string, comment string, identifierQuotes *TokenPair, spec *pf.MaterializationSpec_Binding) *Table {
	return &Table{
...
// statements.
func columnsForMaterialization(spec *pf.MaterializationSpec_Binding, identifierQuotes *TokenPair) []Column {
...
func generateApplyStatements(
	...
	createSQL, err := endpoint.Generator.CreateTable(
		TableForMaterialization(target, comment, &endpoint.Generator.IdentifierQuotes, spec))
	if err != nil {
