...
func (s *Service) Poll() ([]byte, []Frame) {
	...
	// Zero-copy access to []byte arena and []C.Out slices.
	var arena []byte
	...
	// Copy raw C.Out instances to Frames.
	for i, o := range chOut {
