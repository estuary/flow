...
func serveHTTPMultiCollectionJSON(a args, w http.ResponseWriter, r *http.Request) (err error) {
...
func serveHTTPSingleCollectionJSON(a args, w http.ResponseWriter, r *http.Request) (err error) {
