...
func (d driver) Spec(ctx context.Context, req *pc.SpecRequest) (*pc.SpecResponse, error) {
	...
	var err = connector.UnaryRPC(ctx, "spec", connector.Capture, req, resp, d.logger, d.networkName)
	return resp, err
}
...
func (d driver) Discover(ctx context.Context, req *pc.DiscoverRequest) (*pc.DiscoverResponse, error) {
	...
	var err = connector.UnaryRPC(ctx, "discover", connector.Capture, req, resp, d.logger, d.networkName)
	return resp, err
}
...
func (d driver) Validate(ctx context.Context, req *pc.ValidateRequest) (*pc.ValidateResponse, error) {
	...
	var err = connector.UnaryRPC(ctx, "validate", connector.Capture, req, resp, d.logger, d.networkName)
	return resp, err
}
...
func (d driver) ApplyUpsert(ctx context.Context, req *pc.ApplyRequest) (*pc.ApplyResponse, error) {
	...
	var err = connector.UnaryRPC(ctx, "apply-upsert", connector.Capture, req, resp, d.logger, d.networkName)
	return resp, err
}
...
func (d driver) ApplyDelete(ctx context.Context, req *pc.ApplyRequest) (*pc.ApplyResponse, error) {
	var resp = new(pc.ApplyResponse)
	var err = connector.UnaryRPC(ctx, "apply-delete", connector.Capture, req, resp, d.logger, d.networkName)
	return resp, err
}
