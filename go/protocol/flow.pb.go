...
type Shuffle struct {
	...
	UsesSourceKey bool `protobuf:"varint,3,opt,name=uses_source_key,json=usesSourceKey,proto3" json:"uses_source_key,omitempty"`
	...
	FilterRClocks bool         `protobuf:"varint,6,opt,name=filter_r_clocks,json=filterRClocks,proto3" json:"filter_r_clocks,omitempty"`
...
type ShuffleResponse struct {
	...
	// media-type.
	DocsJson []Slice `protobuf:"bytes,9,rep,name=docs_json,json=docsJson,proto3" json:"docs_json"`
	...
	PackedKey []Slice `protobuf:"bytes,13,rep,name=packed_key,json=packedKey,proto3" json:"packed_key"`
	// Extracted shuffle key of each document, with one Field for each
	// component of the composite shuffle key.
	ShuffleKey           []Field  `protobuf:"bytes,14,rep,name=shuffle_key,json=shuffleKey,proto3" json:"shuffle_key"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type DeriveResponse_Continue struct {
	Continue *empty.Empty `protobuf:"bytes,1,opt,name=continue,proto3,oneof" json:"continue,omitempty"`
}
type DeriveResponse_Flush struct {
	Flush *CombineResponse `protobuf:"bytes,2,opt,name=flush,proto3,oneof" json:"flush,omitempty"`
}

func (*DeriveResponse_Continue) isDeriveResponse_Kind() {}
...
func (m *DeriveResponse) GetContinue() *empty.Empty {
	if x, ok := m.GetKind().(*DeriveResponse_Continue); ok {
		return x.Continue
	}
	return nil
}
...
var fileDescriptor_9dd0e7f3bbc7f41f = []byte{
	...
	,
}
...
func (m *DeriveResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Kind = &DeriveResponse_Continue{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Flush", wireType)
