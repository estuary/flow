...
var unquotedIdentifiers = regexp.MustCompile("^[_\\pL]+[_\\pL\\pN]*$")
...
func ColumnForProjection(projection *pf.Projection, quotes *TokenPair) Column {
	var column = Column{
		Name:       projection.Field,
		Identifier: toIdentifier(projection.Field, quotes),
