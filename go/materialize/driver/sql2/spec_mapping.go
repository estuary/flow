...
func generateApplyStatements(endpoint *Endpoint, spec *pf.MaterializationSpec) ([]string, error) {
	...
	var target = TableForMaterialization(endpoint.TargetName(), comment, &endpoint.Generator.IdentifierQuotes, spec)
	...
	insertSpec, err := endpoint.Generator.DirectInsertStatement(
		endpoint.Tables.Specs, endpoint.TargetName(), base64.StdEncoding.EncodeToString(specBytes))
	if err != nil {
