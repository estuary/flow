...
func (TestSpec_Step_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{15, 0, 0}
}
...
func (TaskNetworkProxyResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{32, 0}
}
...
type Shuffle struct {
	...
	DeprecatedSourceSchemaUri string `protobuf:"bytes,8,opt,name=deprecated_source_schema_uri,json=deprecatedSourceSchemaUri,proto3" json:"deprecated_source_schema_uri,omitempty"`
...
type CollectionSpec struct {
	...
	WriteSchemaUri string `protobuf:"bytes,2,opt,name=write_schema_uri,json=writeSchemaUri,proto3" json:"write_schema_uri,omitempty"`
	// Bundled write-time JSON Schema of the collection.
	WriteSchemaJson encoding_json.RawMessage `protobuf:"bytes,8,opt,name=write_schema_json,json=writeSchemaJson,proto3,casttype=encoding/json.RawMessage" json:"write_schema_json,omitempty"`
	...
	ReadSchemaUri string `protobuf:"bytes,10,opt,name=read_schema_uri,json=readSchemaUri,proto3" json:"read_schema_uri,omitempty"`
	// Bundled read-time JSON Schema of the collection.
	// Optional. If not set then `write_schema_json` should be used.
	ReadSchemaJson encoding_json.RawMessage `protobuf:"bytes,11,opt,name=read_schema_json,json=readSchemaJson,proto3,casttype=encoding/json.RawMessage" json:"read_schema_json,omitempty"`
...
type PortSpec struct {
	...
	AlpnProtocol         string   `protobuf:"bytes,2,opt,name=alpn_protocol,json=alpnProtocol,proto3" json:"alpn_protocol,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type CaptureSpec struct {
	...
	Ports                map[string]*PortSpec  `protobuf:"bytes,8,rep,name=ports,proto3" json:"ports,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
type MaterializationSpec struct {
	...
	RecoveryLogTemplate  *protocol.JournalSpec `protobuf:"bytes,6,opt,name=recovery_log_template,json=recoveryLogTemplate,proto3" json:"recovery_log_template,omitempty"`
	Ports                map[string]*PortSpec  `protobuf:"bytes,7,rep,name=ports,proto3" json:"ports,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*DeriveAPI_Invoke) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{22, 3}
}
...
func (*DeriveAPI_Prepare) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{22, 4}
}
...
func (*DeriveAPI_Stats) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{22, 5}
}
...
func (*DeriveAPI_Stats_InvokeStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{22, 5, 0}
}
...
func (*DeriveAPI_Stats_TransformStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{22, 5, 1}
}
...
func (*DeriveAPI_Stats_RegisterStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{22, 5, 2}
}
...
func (*TaskNetworkProxyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{31}
}
...
type TaskNetworkProxyRequest_Open struct {
	...
	Header               *protocol.Header `protobuf:"bytes,4,opt,name=header,proto3" json:"header,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*TaskNetworkProxyRequest_Open) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{31, 0}
}
...
func (*TaskNetworkProxyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{32}
}
...
func init() {
	...
	proto.RegisterType((*PortSpec)(nil), "flow.PortSpec")
	proto.RegisterType((*CaptureSpec)(nil), "flow.CaptureSpec")
	proto.RegisterMapType((map[string]*PortSpec)(nil), "flow.CaptureSpec.PortsEntry")
	...
	proto.RegisterMapType((map[string]*PortSpec)(nil), "flow.MaterializationSpec.PortsEntry")
...
var fileDescriptor_d0677502142fec31 = []byte{
	...
	,
}
...
func (this *Shuffle) Equal(that interface{}) bool {
	...
	if this.DeprecatedSourceSchemaUri != that1.DeprecatedSourceSchemaUri {
		return false
	}
...
func (m *Shuffle) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DeprecatedSourceSchemaUri) > 0 {
		i -= len(m.DeprecatedSourceSchemaUri)
		copy(dAtA[i:], m.DeprecatedSourceSchemaUri)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.DeprecatedSourceSchemaUri)))
		i--
		dAtA[i] = 0x42
	}
...
func (m *CollectionSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReadSchemaUri) > 0 {
		i -= len(m.ReadSchemaUri)
		copy(dAtA[i:], m.ReadSchemaUri)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.ReadSchemaUri)))
		i--
		dAtA[i] = 0x52
	}
	...
	if len(m.WriteSchemaUri) > 0 {
		i -= len(m.WriteSchemaUri)
		copy(dAtA[i:], m.WriteSchemaUri)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.WriteSchemaUri)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *PortSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AlpnProtocol) > 0 {
		...
		i = encodeVarintFlow(dAtA, i, uint64(len(m.AlpnProtocol)))
		i--
		dAtA[i] = 0x12
	}
	if m.ContainerPort != 0 {
		i = encodeVarintFlow(dAtA, i, uint64(m.ContainerPort))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *TaskNetworkProxyRequest_Open) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ClientIp) > 0 {
		...
		i = encodeVarintFlow(dAtA, i, uint64(len(m.ClientIp)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.PortName) > 0 {
		...
		i = encodeVarintFlow(dAtA, i, uint64(len(m.PortName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ShardId) > 0 {
...
func (m *Shuffle) ProtoSize() (n int) {
	...
	l = len(m.DeprecatedSourceSchemaUri)
	if l > 0 {
		n += 1 + l + sovFlow(uint64(l))
	}
	if m.FilterRClocks {
...
func (m *PortSpec) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ContainerPort != 0 {
		n += 1 + sovFlow(uint64(m.ContainerPort))
	}
...
func (m *Shuffle) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeprecatedSourceSchemaUri", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeprecatedSourceSchemaUri = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 0 {
...
func (m *CollectionSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WriteSchemaUri", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WriteSchemaUri = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadSchemaUri", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReadSchemaUri = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
...
func (m *CaptureSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.Ports == nil {
				m.Ports = make(map[string]*PortSpec)
			}
			var mapkey string
			var mapvalue *PortSpec
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
