...
const (
	...
	DeriveAPI_CONFIGURE DeriveAPI_Code = 0
	// Restore a checkoint (Go -> Rust).
	DeriveAPI_RESTORE_CHECKPOINT DeriveAPI_Code = 1
	// Begin a new transaction (Go -> Rust).
	DeriveAPI_BEGIN_TRANSACTION DeriveAPI_Code = 2
	// Next source document header (Go -> Rust).
	DeriveAPI_NEXT_DOCUMENT_HEADER DeriveAPI_Code = 3
	// Next source document body (Go -> Rust).
	DeriveAPI_NEXT_DOCUMENT_BODY DeriveAPI_Code = 4
	// Next drained document is partially combined (Rust -> Go).
	...
	DeriveAPI_TRAMPOLINE DeriveAPI_Code = 9
	// Trampoline sub-type: invoke transform lambda.
	DeriveAPI_TRAMPOLINE_INVOKE DeriveAPI_Code = 10
	// Flush transaction (Go -> Rust).
	DeriveAPI_FLUSH_TRANSACTION DeriveAPI_Code = 12
	// Prepare transaction to commit (Go -> Rust).
	DeriveAPI_PREPARE_TO_COMMIT DeriveAPI_Code = 13
	// Clear registers values (test support only; Go -> Rust).
	DeriveAPI_CLEAR_REGISTERS DeriveAPI_Code = 14
)
...
var DeriveAPI_Code_name = map[int32]string{
	...
	2:  "BEGIN_TRANSACTION",
	3:  "NEXT_DOCUMENT_HEADER",
	4:  "NEXT_DOCUMENT_BODY",
	5:  "DRAINED_COMBINED_DOCUMENT",
	6:  "DRAINED_REDUCED_DOCUMENT",
	7:  "DRAINED_KEY",
	8:  "DRAINED_FIELDS",
	9:  "TRAMPOLINE",
	10: "TRAMPOLINE_INVOKE",
	12: "FLUSH_TRANSACTION",
	13: "PREPARE_TO_COMMIT",
	14: "CLEAR_REGISTERS",
}
...
var DeriveAPI_Code_value = map[string]int32{
	...
	"BEGIN_TRANSACTION":         2,
	"NEXT_DOCUMENT_HEADER":      3,
	"NEXT_DOCUMENT_BODY":        4,
	"DRAINED_COMBINED_DOCUMENT": 5,
	"DRAINED_REDUCED_DOCUMENT":  6,
	"DRAINED_KEY":               7,
	"DRAINED_FIELDS":            8,
	"TRAMPOLINE":                9,
	"TRAMPOLINE_INVOKE":         10,
	"FLUSH_TRANSACTION":         12,
	"PREPARE_TO_COMMIT":         13,
	"CLEAR_REGISTERS":           14,
}
...
var fileDescriptor_d0677502142fec31 = []byte{
	...
	,
}
...
func (m *ShuffleResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Begin) > 0 {
		dAtA25 := make([]byte, len(m.Begin)*10)
		var j24 int
