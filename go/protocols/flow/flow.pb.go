...
type Inference_Reduce int32

const (
	Inference_REDUCE_UNSET             Inference_Reduce = 0
	Inference_REDUCE_MULTIPLE          Inference_Reduce = 1
	Inference_REDUCE_APPEND            Inference_Reduce = 2
	Inference_REDUCE_FIRST_WRITE_WINS  Inference_Reduce = 3
	Inference_REDUCE_LAST_WRITE_WINS   Inference_Reduce = 4
	Inference_REDUCE_MAXIMIZE          Inference_Reduce = 5
	Inference_REDUCE_MERGE             Inference_Reduce = 6
	Inference_REDUCE_MINIMIZE          Inference_Reduce = 7
	Inference_REDUCE_SET               Inference_Reduce = 8
	Inference_REDUCE_SUM               Inference_Reduce = 9
	Inference_REDUCE_JSON_SCHEMA_MERGE Inference_Reduce = 10
)

var Inference_Reduce_name = map[int32]string{
	0:  "REDUCE_UNSET",
	1:  "REDUCE_MULTIPLE",
	2:  "REDUCE_APPEND",
	3:  "REDUCE_FIRST_WRITE_WINS",
	4:  "REDUCE_LAST_WRITE_WINS",
	5:  "REDUCE_MAXIMIZE",
	6:  "REDUCE_MERGE",
	7:  "REDUCE_MINIMIZE",
	8:  "REDUCE_SET",
	9:  "REDUCE_SUM",
	10: "REDUCE_JSON_SCHEMA_MERGE",
}

var Inference_Reduce_value = map[string]int32{
	"REDUCE_UNSET":             0,
	"REDUCE_MULTIPLE":          1,
	"REDUCE_APPEND":            2,
	"REDUCE_FIRST_WRITE_WINS":  3,
	"REDUCE_LAST_WRITE_WINS":   4,
	"REDUCE_MAXIMIZE":          5,
	"REDUCE_MERGE":             6,
	"REDUCE_MINIMIZE":          7,
	"REDUCE_SET":               8,
	"REDUCE_SUM":               9,
	"REDUCE_JSON_SCHEMA_MERGE": 10,
}

func (x Inference_Reduce) String() string {
	return proto.EnumName(Inference_Reduce_name, int32(x))
}

func (Inference_Reduce) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{3, 1}
}

// Redact enumerates the possible `redact` strategies for a location.
type Inference_Redact int32

const (
	Inference_REDACT_UNSET    Inference_Redact = 0
	Inference_REDACT_MULTIPLE Inference_Redact = 1
	Inference_REDACT_BLOCK    Inference_Redact = 2
	Inference_REDACT_SHA256   Inference_Redact = 3
)

var Inference_Redact_name = map[int32]string{
	0: "REDACT_UNSET",
	1: "REDACT_MULTIPLE",
	2: "REDACT_BLOCK",
	3: "REDACT_SHA256",
...
var Inference_Redact_value = map[string]int32{
	"REDACT_UNSET":    0,
	"REDACT_MULTIPLE": 1,
	"REDACT_BLOCK":    2,
	"REDACT_SHA256":   3,
...
func (x Inference_Redact) String() string {
	return proto.EnumName(Inference_Redact_name, int32(x))
}

func (Inference_Redact) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{3, 2}
}
...
const (
	...
	CollectionSpec_Derivation_PYTHON                 CollectionSpec_Derivation_ConnectorType = 5
)
...
const (
	...
	MaterializationSpec_DEKAF   MaterializationSpec_ConnectorType = 10
)
...
// extensions.
type SyncNowResponse_Status int32

const (
	SyncNowResponse_OK SyncNowResponse_Status = 0
	// The named shard does not exist.
	SyncNowResponse_SHARD_NOT_FOUND SyncNowResponse_Status = 1
	// There is no current primary consumer process for the shard. This is a
	// temporary condition which the client should retry.
	SyncNowResponse_NO_SHARD_PRIMARY SyncNowResponse_Status = 2
	// The present consumer process is not the assigned primary for the shard.
	// Header carries the resolved route so the client can retry the primary.
	SyncNowResponse_NOT_SHARD_PRIMARY SyncNowResponse_Status = 3
	// An error in the sync-now machinery (e.g. Etcd transaction failure).
	SyncNowResponse_INTERNAL_ERROR SyncNowResponse_Status = 4
	// The shard is the primary here but has no running V2 session/container.
	SyncNowResponse_SHARD_STOPPED SyncNowResponse_Status = 5
	// The shard runs the legacy (V1) runtime, which has no sync-now path.
	SyncNowResponse_NOT_SUPPORTED SyncNowResponse_Status = 6
	// The forced transaction did not commit within the allotted time.
	SyncNowResponse_TIMEOUT SyncNowResponse_Status = 7
)

var SyncNowResponse_Status_name = map[int32]string{
	0: "OK",
	1: "SHARD_NOT_FOUND",
	2: "NO_SHARD_PRIMARY",
	3: "NOT_SHARD_PRIMARY",
...
var SyncNowResponse_Status_value = map[string]int32{
	"OK":                0,
	"SHARD_NOT_FOUND":   1,
	"NO_SHARD_PRIMARY":  2,
	"NOT_SHARD_PRIMARY": 3,
...
func (x SyncNowResponse_Status) String() string {
	return proto.EnumName(SyncNowResponse_Status_name, int32(x))
}

func (SyncNowResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{25, 0}
}
...
type Inference struct {
	...
	Array   *Inference_Array   `protobuf:"bytes,10,opt,name=array,proto3" json:"array,omitempty"`
	// Possible enum values from the schema, or empty if the location is not an enum.
	EnumJsonVec []encoding_json.RawMessage `protobuf:"bytes,11,rep,name=enum_json_vec,json=enum,proto3,casttype=encoding/json.RawMessage" json:"enum_json_vec,omitempty"`
	// Applied `reduce` strategy.
	Reduce Inference_Reduce `protobuf:"varint,12,opt,name=reduce,proto3,enum=flow.Inference_Reduce" json:"reduce,omitempty"`
	// Applied `redact` strategy.
	Redact Inference_Redact `protobuf:"varint,13,opt,name=redact,proto3,enum=flow.Inference_Redact" json:"redact,omitempty"`
	...
	ContentMediaType     string   `protobuf:"bytes,14,opt,name=content_media_type,json=contentMediaType,proto3" json:"content_media_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Inference_String struct {
	...
	// bound.
	StrMinimum string `protobuf:"bytes,8,opt,name=str_minimum,json=strMinimum,proto3" json:"str_minimum,omitempty"`
	...
	// bound.
	StrMaximum           string   `protobuf:"bytes,9,opt,name=str_maximum,json=strMaximum,proto3" json:"str_maximum,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Inference_Array struct {
	...
	HasMaxItems bool `protobuf:"varint,2,opt,name=has_max_items,json=hasMaxItems,proto3" json:"has_max_items,omitempty"`
...
func (m *Inference_Array) Reset()         { *m = Inference_Array{} }
func (m *Inference_Array) String() string { return proto.CompactTextString(m) }
func (*Inference_Array) ProtoMessage()    {}
func (*Inference_Array) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{3, 2}
}
func (m *Inference_Array) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Inference_Array) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Inference_Array.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Inference_Array) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Inference_Array.Merge(m, src)
}
func (m *Inference_Array) XXX_Size() int {
	return m.ProtoSize()
}
func (m *Inference_Array) XXX_DiscardUnknown() {
	xxx_messageInfo_Inference_Array.DiscardUnknown(m)
}

var xxx_messageInfo_Inference_Array proto.InternalMessageInfo
...
type CollectionSpec_Derivation struct {
	...
	InactiveTransforms []*CollectionSpec_Derivation_Transform `protobuf:"bytes,8,rep,name=inactive_transforms,json=inactiveTransforms,proto3" json:"inactive_transforms,omitempty"`
	// Salt used for redacting sensitive fields in derived documents.
	RedactSalt           []byte   `protobuf:"bytes,9,opt,name=redact_salt,json=redactSalt,proto3" json:"redact_salt,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type CollectionSpec_Derivation_Transform struct {
	...
	StateKey             string   `protobuf:"bytes,14,opt,name=state_key,json=stateKey,proto3" json:"state_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type CaptureSpec struct {
	...
	InactiveBindings []*CaptureSpec_Binding `protobuf:"bytes,9,rep,name=inactive_bindings,json=inactiveBindings,proto3" json:"inactive_bindings,omitempty"`
...
type MaterializationSpec struct {
	...
	// Inactive bindings are unique by their resource path, and have no
	// overlap with active bindings.
	InactiveBindings []*MaterializationSpec_Binding `protobuf:"bytes,9,rep,name=inactive_bindings,json=inactiveBindings,proto3" json:"inactive_bindings,omitempty"`
...
type MaterializationSpec_Binding struct {
	...
	SerPolicy            *SerPolicy `protobuf:"bytes,14,opt,name=ser_policy,json=serPolicy,proto3" json:"ser_policy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
type SyncNowRequest struct {
	...
	ShardId go_gazette_dev_core_consumer_protocol.ShardID `protobuf:"bytes,1,opt,name=shard_id,json=shardId,proto3,casttype=go.gazette.dev/core/consumer/protocol.ShardID" json:"shard_id,omitempty"`
...
type SyncNowResponse struct {
	Status               SyncNowResponse_Status `protobuf:"varint,1,opt,name=status,proto3,enum=flow.SyncNowResponse_Status" json:"status,omitempty"`
	Header               *protocol.Header       `protobuf:"bytes,2,opt,name=header,proto3" json:"header,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
...
func init() {
	...
	proto.RegisterEnum("flow.Inference_Reduce", Inference_Reduce_name, Inference_Reduce_value)
	proto.RegisterEnum("flow.Inference_Redact", Inference_Redact_name, Inference_Redact_value)
	...
	proto.RegisterEnum("flow.SyncNowResponse_Status", SyncNowResponse_Status_name, SyncNowResponse_Status_value)
	...
	proto.RegisterType((*Inference_Array)(nil), "flow.Inference.Array")
	...
	proto.RegisterType((*SyncNowRequest)(nil), "flow.SyncNowRequest")
	proto.RegisterType((*SyncNowResponse)(nil), "flow.SyncNowResponse")
}
...
var fileDescriptor_d0677502142fec31 = []byte{
	...
	,
}
...
// SyncNowClient is the client API for SyncNow service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type SyncNowClient interface {
	SyncNow(ctx context.Context, in *SyncNowRequest, opts ...grpc.CallOption) (*SyncNowResponse, error)
}

type syncNowClient struct {
	cc *grpc.ClientConn
}

func NewSyncNowClient(cc *grpc.ClientConn) SyncNowClient {
	return &syncNowClient{cc}
}

func (c *syncNowClient) SyncNow(ctx context.Context, in *SyncNowRequest, opts ...grpc.CallOption) (*SyncNowResponse, error) {
	out := new(SyncNowResponse)
	err := c.cc.Invoke(ctx, "/flow.SyncNow/SyncNow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// SyncNowServer is the server API for SyncNow service.
type SyncNowServer interface {
	SyncNow(context.Context, *SyncNowRequest) (*SyncNowResponse, error)
}

// UnimplementedSyncNowServer can be embedded to have forward compatible implementations.
type UnimplementedSyncNowServer struct {
}

func (*UnimplementedSyncNowServer) SyncNow(ctx context.Context, req *SyncNowRequest) (*SyncNowResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SyncNow not implemented")
}

func RegisterSyncNowServer(s *grpc.Server, srv SyncNowServer) {
	s.RegisterService(&_SyncNow_serviceDesc, srv)
}

func _SyncNow_SyncNow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncNowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncNowServer).SyncNow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flow.SyncNow/SyncNow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncNowServer).SyncNow(ctx, req.(*SyncNowRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _SyncNow_serviceDesc = grpc.ServiceDesc{
	ServiceName: "flow.SyncNow",
	HandlerType: (*SyncNowServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SyncNow",
			Handler:    _SyncNow_SyncNow_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "go/protocols/flow/flow.proto",
...
func (m *Inference) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ContentMediaType) > 0 {
		i -= len(m.ContentMediaType)
		copy(dAtA[i:], m.ContentMediaType)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.ContentMediaType)))
		i--
		dAtA[i] = 0x72
	}
	if m.Redact != 0 {
		i = encodeVarintFlow(dAtA, i, uint64(m.Redact))
		i--
		dAtA[i] = 0x68
	}
	if m.Reduce != 0 {
		i = encodeVarintFlow(dAtA, i, uint64(m.Reduce))
		i--
		dAtA[i] = 0x60
	}
	if len(m.EnumJsonVec) > 0 {
		for iNdEx := len(m.EnumJsonVec) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.EnumJsonVec[iNdEx])
			copy(dAtA[i:], m.EnumJsonVec[iNdEx])
			i = encodeVarintFlow(dAtA, i, uint64(len(m.EnumJsonVec[iNdEx])))
			i--
			dAtA[i] = 0x5a
		}
	}
...
func (m *Inference_String) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StrMaximum) > 0 {
		i -= len(m.StrMaximum)
		copy(dAtA[i:], m.StrMaximum)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.StrMaximum)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.StrMinimum) > 0 {
		i -= len(m.StrMinimum)
		copy(dAtA[i:], m.StrMinimum)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.StrMinimum)))
		i--
		dAtA[i] = 0x42
	}
...
func (m *Inference_Array) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Inference_Array) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Inference_Array) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ItemTypes) > 0 {
		for iNdEx := len(m.ItemTypes) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintFlow(dAtA, i, uint64(len(m.ItemTypes[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if m.MaxItems != 0 {
		i = encodeVarintFlow(dAtA, i, uint64(m.MaxItems))
		i--
		dAtA[i] = 0x18
	}
	if m.HasMaxItems {
	...
	if m.MinItems != 0 {
		i = encodeVarintFlow(dAtA, i, uint64(m.MinItems))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *CollectionSpec_Derivation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RedactSalt) > 0 {
		i -= len(m.RedactSalt)
		copy(dAtA[i:], m.RedactSalt)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.RedactSalt)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.InactiveTransforms) > 0 {
		for iNdEx := len(m.InactiveTransforms) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.InactiveTransforms[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *CaptureSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.InactiveBindings) > 0 {
		for iNdEx := len(m.InactiveBindings) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.InactiveBindings[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MaterializationSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TriggersJson) > 0 {
		i -= len(m.TriggersJson)
		copy(dAtA[i:], m.TriggersJson)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.TriggersJson)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.InactiveBindings) > 0 {
...
func (m *Inference) ProtoSize() (n int) {
	...
	if len(m.EnumJsonVec) > 0 {
		for _, b := range m.EnumJsonVec {
			l = len(b)
			n += 1 + l + sovFlow(uint64(l))
		}
	}
	if m.Reduce != 0 {
		n += 1 + sovFlow(uint64(m.Reduce))
	}
	if m.Redact != 0 {
		n += 1 + sovFlow(uint64(m.Redact))
	}
	l = len(m.ContentMediaType)
	if l > 0 {
		n += 1 + l + sovFlow(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *Inference_Array) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MinItems != 0 {
		n += 1 + sovFlow(uint64(m.MinItems))
	}
	if m.HasMaxItems {
		n += 2
	}
	if m.MaxItems != 0 {
		n += 1 + sovFlow(uint64(m.MaxItems))
	}
	if len(m.ItemTypes) > 0 {
...
func (m *CollectionSpec_Derivation) ProtoSize() (n int) {
	...
	if len(m.InactiveTransforms) > 0 {
		for _, e := range m.InactiveTransforms {
			l = e.ProtoSize()
			n += 1 + l + sovFlow(uint64(l))
		}
	}
...
func (m *CaptureSpec) ProtoSize() (n int) {
	...
	if len(m.InactiveBindings) > 0 {
		for _, e := range m.InactiveBindings {
			l = e.ProtoSize()
			n += 1 + l + sovFlow(uint64(l))
		}
	}
...
func (m *Inference) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.DefaultJson = append(m.DefaultJson[:0], dAtA[iNdEx:postIndex]...)
			if m.DefaultJson == nil {
				m.DefaultJson = []byte{}
			}
			iNdEx = postIndex
		case 7:
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnumJsonVec", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnumJsonVec = append(m.EnumJsonVec, make([]byte, postIndex-iNdEx))
			copy(m.EnumJsonVec[len(m.EnumJsonVec)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 12:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Reduce |= Inference_Reduce(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Redact |= Inference_Redact(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContentMediaType", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ContentMediaType = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipFlow(dAtA[iNdEx:])
...
func (m *Inference_String) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StrMinimum", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StrMinimum = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StrMaximum", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StrMaximum = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipFlow(dAtA[iNdEx:])
...
func (m *Inference_Array) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinItems |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CollectionSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.AckTemplateJson = append(m.AckTemplateJson[:0], dAtA[iNdEx:postIndex]...)
			if m.AckTemplateJson == nil {
				m.AckTemplateJson = []byte{}
			}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			m.WriteSchemaJson = append(m.WriteSchemaJson[:0], dAtA[iNdEx:postIndex]...)
			if m.WriteSchemaJson == nil {
				m.WriteSchemaJson = []byte{}
			}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
		...
		case 11:
			...
			m.ReadSchemaJson = append(m.ReadSchemaJson[:0], dAtA[iNdEx:postIndex]...)
			if m.ReadSchemaJson == nil {
				m.ReadSchemaJson = []byte{}
			}
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
...
func (m *CollectionSpec_Derivation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InactiveTransforms", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InactiveTransforms = append(m.InactiveTransforms, &CollectionSpec_Derivation_Transform{})
			if err := m.InactiveTransforms[len(m.InactiveTransforms)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RedactSalt", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RedactSalt = append(m.RedactSalt[:0], dAtA[iNdEx:postIndex]...)
			if m.RedactSalt == nil {
				m.RedactSalt = []byte{}
			}
			iNdEx = postIndex
...
func (m *CollectionSpec_Derivation_Transform) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.ShuffleLambdaConfigJson = append(m.ShuffleLambdaConfigJson[:0], dAtA[iNdEx:postIndex]...)
			if m.ShuffleLambdaConfigJson == nil {
				m.ShuffleLambdaConfigJson = []byte{}
			}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			m.LambdaConfigJson = append(m.LambdaConfigJson[:0], dAtA[iNdEx:postIndex]...)
			if m.LambdaConfigJson == nil {
				m.LambdaConfigJson = []byte{}
			}
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
...
func (m *CaptureSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InactiveBindings", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InactiveBindings = append(m.InactiveBindings, &CaptureSpec_Binding{})
			if err := m.InactiveBindings[len(m.InactiveBindings)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
...
func (m *MaterializationSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.InactiveBindings = append(m.InactiveBindings, &MaterializationSpec_Binding{})
			if err := m.InactiveBindings[len(m.InactiveBindings)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TriggersJson", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TriggersJson = append(m.TriggersJson[:0], dAtA[iNdEx:postIndex]...)
			if m.TriggersJson == nil {
				m.TriggersJson = []byte{}
			}
			iNdEx = postIndex
		default:
...
func (m *TestSpec_Step) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.DocsJsonVec = append(m.DocsJsonVec, make([]byte, postIndex-iNdEx))
			copy(m.DocsJsonVec[len(m.DocsJsonVec)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
...
func (m *ConnectorState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.UpdatedJson = append(m.UpdatedJson[:0], dAtA[iNdEx:postIndex]...)
			if m.UpdatedJson == nil {
				m.UpdatedJson = []byte{}
			}
			iNdEx = postIndex
		case 2:
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= SyncNowResponse_Status(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
