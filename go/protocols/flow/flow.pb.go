...
const (
	...
	BuildAPI_FETCH_REQUEST     BuildAPI_Code = 2
	BuildAPI_FETCH_SUCCESS     BuildAPI_Code = 3
	BuildAPI_FETCH_FAILED      BuildAPI_Code = 4
	BuildAPI_VALIDATE_REQUEST  BuildAPI_Code = 5
	BuildAPI_VALIDATE_RESPONSE BuildAPI_Code = 6
	BuildAPI_DONE              BuildAPI_Code = 7
	BuildAPI_DONE_WITH_ERRORS  BuildAPI_Code = 8
...
type TestSpec_Step struct {
	...
	Collection Collection `protobuf:"bytes,2,opt,name=collection,proto3,casttype=Collection" json:"collection,omitempty"`
	// Documents ingested or verified by this step, as a JSON-encoded array.
	DocumentsJson string `protobuf:"bytes,3,opt,name=documents_json,json=documentsJson,proto3" json:"documents_json,omitempty"`
	// When verifying, selector over logical partitions of the collection.
	Partitions           protocol.LabelSelector `protobuf:"bytes,4,opt,name=partitions,proto3" json:"partitions"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
type BuildAPI_Config struct {
	...
	AddDevelopmentRules  bool     `protobuf:"varint,6,opt,name=add_development_rules,json=addDevelopmentRules,proto3" json:"add_development_rules,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_d0677502142fec31 = []byte{
	...
	,
}
...
func (m *TestSpec_Step) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x22
	if len(m.DocumentsJson) > 0 {
		i -= len(m.DocumentsJson)
		copy(dAtA[i:], m.DocumentsJson)
		i = encodeVarintFlow(dAtA, i, uint64(len(m.DocumentsJson)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Collection) > 0 {
...
func (m *ShuffleResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.End) > 0 {
		...
		i = encodeVarintFlow(dAtA, i, uint64(j20))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.Begin) > 0 {
		dAtA23 := make([]byte, len(m.Begin)*10)
		var j22 int
...
func (m *TestSpec_Step) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DocumentsJson", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DocumentsJson = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *BuildAPI_Config) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddDevelopmentRules", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AddDevelopmentRules = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipFlow(dAtA[iNdEx:])
			if err != nil {
