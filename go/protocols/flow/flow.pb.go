...
type SerPolicy struct {
	...
	RootObjTruncateAfter   uint32   `protobuf:"varint,2,opt,name=root_obj_truncate_after,json=rootObjTruncateAfter,proto3" json:"root_obj_truncate_after,omitempty"`
	NestedObjTruncateAfter uint32   `protobuf:"varint,3,opt,name=nested_obj_truncate_after,json=nestedObjTruncateAfter,proto3" json:"nested_obj_truncate_after,omitempty"`
	ArrayTruncateAfter     uint32   `protobuf:"varint,4,opt,name=array_truncate_after,json=arrayTruncateAfter,proto3" json:"array_truncate_after,omitempty"`
	XXX_NoUnkeyedLiteral   struct{} `json:"-"`
	XXX_unrecognized       []byte   `json:"-"`
	XXX_sizecache          int32    `json:"-"`
}
...
type CombineAPI_Config struct {
	...
	SerPolicy            *SerPolicy `protobuf:"bytes,8,opt,name=ser_policy,json=serPolicy,proto3" json:"ser_policy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*CombineAPI_Stats) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0677502142fec31, []int{15, 1}
}
...
var fileDescriptor_d0677502142fec31 = []byte{
	...
	,
}
...
func (m *SerPolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RootObjTruncateAfter != 0 {
		i = encodeVarintFlow(dAtA, i, uint64(m.RootObjTruncateAfter))
		i--
		dAtA[i] = 0x10
	}
...
func (m *SerPolicy) ProtoSize() (n int) {
	...
	if m.RootObjTruncateAfter != 0 {
		n += 1 + sovFlow(uint64(m.RootObjTruncateAfter))
	}
	if m.NestedObjTruncateAfter != 0 {
...
func (m *SerPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RootObjTruncateAfter", wireType)
			}
			m.RootObjTruncateAfter = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowFlow
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RootObjTruncateAfter |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
