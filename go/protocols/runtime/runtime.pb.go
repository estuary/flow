...
type CaptureRequestExt_StartCommit struct {
	...
	PublishedControlClocks []*CaptureRequestExt_StartCommit_PublishedControlClock `protobuf:"bytes,2,rep,name=published_control_clocks,json=publishedControlClocks,proto3" json:"published_control_clocks,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                                               `json:"-"`
	XXX_unrecognized       []byte                                                 `json:"-"`
	XXX_sizecache          int32                                                  `json:"-"`
}
...
type CaptureRequestExt_StartCommit_PublishedControlClock struct {
...
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) Reset() {
	*m = CaptureRequestExt_StartCommit_PublishedControlClock{}
}
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) String() string {
	return proto.CompactTextString(m)
}
func (*CaptureRequestExt_StartCommit_PublishedControlClock) ProtoMessage() {}
func (*CaptureRequestExt_StartCommit_PublishedControlClock) Descriptor() ([]byte, []int) {
	return fileDescriptor_73af6e0737ce390c, []int{5, 0, 0}
}
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CaptureRequestExt_StartCommit_PublishedControlClock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CaptureRequestExt_StartCommit_PublishedControlClock.Merge(m, src)
}
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) XXX_Size() int {
	return m.ProtoSize()
}
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) XXX_DiscardUnknown() {
	xxx_messageInfo_CaptureRequestExt_StartCommit_PublishedControlClock.DiscardUnknown(m)
}

var xxx_messageInfo_CaptureRequestExt_StartCommit_PublishedControlClock proto.InternalMessageInfo
...
type CaptureResponseExt struct {
	...
	BackfillState        *CaptureResponseExt_BackfillState `protobuf:"bytes,5,opt,name=backfill_state,json=backfillState,proto3" json:"backfill_state,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
type CaptureResponseExt_BackfillState struct {
	ActiveBackfills      []*CaptureResponseExt_BackfillState_ActiveBackfill `protobuf:"bytes,1,rep,name=active_backfills,json=activeBackfills,proto3" json:"active_backfills,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                           `json:"-"`
	XXX_unrecognized     []byte                                             `json:"-"`
	XXX_sizecache        int32                                              `json:"-"`
}

func (m *CaptureResponseExt_BackfillState) Reset()         { *m = CaptureResponseExt_BackfillState{} }
func (m *CaptureResponseExt_BackfillState) String() string { return proto.CompactTextString(m) }
func (*CaptureResponseExt_BackfillState) ProtoMessage()    {}
func (*CaptureResponseExt_BackfillState) Descriptor() ([]byte, []int) {
	return fileDescriptor_73af6e0737ce390c, []int{6, 0}
}
func (m *CaptureResponseExt_BackfillState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CaptureResponseExt_BackfillState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CaptureResponseExt_BackfillState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CaptureResponseExt_BackfillState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CaptureResponseExt_BackfillState.Merge(m, src)
}
func (m *CaptureResponseExt_BackfillState) XXX_Size() int {
	return m.ProtoSize()
}
func (m *CaptureResponseExt_BackfillState) XXX_DiscardUnknown() {
	xxx_messageInfo_CaptureResponseExt_BackfillState.DiscardUnknown(m)
}

var xxx_messageInfo_CaptureResponseExt_BackfillState proto.InternalMessageInfo

type CaptureResponseExt_BackfillState_ActiveBackfill struct {
	Binding              uint32   `protobuf:"varint,1,opt,name=binding,proto3" json:"binding,omitempty"`
	TruncatedAtClock     uint64   `protobuf:"fixed64,2,opt,name=truncated_at_clock,json=truncatedAtClock,proto3" json:"truncated_at_clock,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *CaptureResponseExt_BackfillState_ActiveBackfill) Reset() {
	*m = CaptureResponseExt_BackfillState_ActiveBackfill{}
}
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) String() string {
	return proto.CompactTextString(m)
}
func (*CaptureResponseExt_BackfillState_ActiveBackfill) ProtoMessage() {}
func (*CaptureResponseExt_BackfillState_ActiveBackfill) Descriptor() ([]byte, []int) {
	return fileDescriptor_73af6e0737ce390c, []int{6, 0, 0}
}
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CaptureResponseExt_BackfillState_ActiveBackfill.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CaptureResponseExt_BackfillState_ActiveBackfill.Merge(m, src)
}
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) XXX_Size() int {
	return m.ProtoSize()
}
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) XXX_DiscardUnknown() {
	xxx_messageInfo_CaptureResponseExt_BackfillState_ActiveBackfill.DiscardUnknown(m)
}

var xxx_messageInfo_CaptureResponseExt_BackfillState_ActiveBackfill proto.InternalMessageInfo
...
type CaptureResponseExt_Opened struct {
	...
	BackfillState        *CaptureResponseExt_BackfillState `protobuf:"bytes,2,opt,name=backfill_state,json=backfillState,proto3" json:"backfill_state,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
type CaptureResponseExt_Captured struct {
	...
	UuidFlags uint32 `protobuf:"varint,3,opt,name=uuid_flags,json=uuidFlags,proto3" json:"uuid_flags,omitempty"`
	...
	ReportUuidClock      bool     `protobuf:"varint,4,opt,name=report_uuid_clock,json=reportUuidClock,proto3" json:"report_uuid_clock,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*CaptureResponseExt_Checkpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_73af6e0737ce390c, []int{6, 3}
}
...
func init() {
	...
	proto.RegisterType((*CaptureRequestExt_StartCommit_PublishedControlClock)(nil), "runtime.CaptureRequestExt.StartCommit.PublishedControlClock")
	proto.RegisterType((*CaptureResponseExt)(nil), "runtime.CaptureResponseExt")
	proto.RegisterType((*CaptureResponseExt_BackfillState)(nil), "runtime.CaptureResponseExt.BackfillState")
	proto.RegisterType((*CaptureResponseExt_BackfillState_ActiveBackfill)(nil), "runtime.CaptureResponseExt.BackfillState.ActiveBackfill")
...
var fileDescriptor_73af6e0737ce390c = []byte{
	...
	,
}
...
func (m *CaptureRequestExt_StartCommit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PublishedControlClocks) > 0 {
		for iNdEx := len(m.PublishedControlClocks) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PublishedControlClocks[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CaptureRequestExt_StartCommit_PublishedControlClock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CaptureResponseExt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BackfillState != nil {
		{
			size, err := m.BackfillState.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CaptureResponseExt_BackfillState) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CaptureResponseExt_BackfillState) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CaptureResponseExt_BackfillState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ActiveBackfills) > 0 {
		for iNdEx := len(m.ActiveBackfills) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ActiveBackfills[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CaptureResponseExt_BackfillState_ActiveBackfill) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.TruncatedAtClock != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(m.TruncatedAtClock))
		i--
		dAtA[i] = 0x11
	}
	if m.Binding != 0 {
...
func (m *CaptureResponseExt_Captured) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UuidFlags != 0 {
		i = encodeVarintRuntime(dAtA, i, uint64(m.UuidFlags))
		i--
		dAtA[i] = 0x18
	}
...
func (m *CaptureRequestExt_StartCommit) ProtoSize() (n int) {
	...
	if len(m.PublishedControlClocks) > 0 {
		for _, e := range m.PublishedControlClocks {
			l = e.ProtoSize()
			n += 1 + l + sovRuntime(uint64(l))
		}
	}
...
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CaptureResponseExt_BackfillState) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.ActiveBackfills) > 0 {
		for _, e := range m.ActiveBackfills {
			l = e.ProtoSize()
			n += 1 + l + sovRuntime(uint64(l))
		}
	}
...
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CaptureResponseExt_Captured) ProtoSize() (n int) {
	...
	if m.UuidFlags != 0 {
		n += 1 + sovRuntime(uint64(m.UuidFlags))
	}
	if m.ReportUuidClock {
		n += 2
	}
...
func (m *CaptureRequestExt_StartCommit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PublishedControlClocks", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PublishedControlClocks = append(m.PublishedControlClocks, &CaptureRequestExt_StartCommit_PublishedControlClock{})
			if err := m.PublishedControlClocks[len(m.PublishedControlClocks)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CaptureRequestExt_StartCommit_PublishedControlClock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PublishedControlClock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PublishedControlClock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *CaptureResponseExt) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BackfillState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BackfillState == nil {
				m.BackfillState = &CaptureResponseExt_BackfillState{}
			}
			if err := m.BackfillState.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CaptureResponseExt_BackfillState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BackfillState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BackfillState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.ActiveBackfills = append(m.ActiveBackfills, &CaptureResponseExt_BackfillState_ActiveBackfill{})
			if err := m.ActiveBackfills[len(m.ActiveBackfills)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CaptureResponseExt_BackfillState_ActiveBackfill) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ActiveBackfill: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ActiveBackfill: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field TruncatedAtClock", wireType)
			}
			m.TruncatedAtClock = 0
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			}
			m.TruncatedAtClock = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		default:
			iNdEx = preIndex
			skippy, err := skipRuntime(dAtA[iNdEx:])
...
func (m *CaptureResponseExt_Captured) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UuidFlags", wireType)
			}
			m.UuidFlags = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UuidFlags |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReportUuidClock", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
