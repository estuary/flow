...
const (
	...
	Codec_CODEC_PROTO Codec = 0
	// Newline-delimited JSON.
	Codec_CODEC_JSON Codec = 1
)
...
type ProxyFeature int32

const (
	// Unused zero value: no feature.
	ProxyFeature_PROXY_FEATURE_NONE ProxyFeature = 0
	...
	ProxyFeature_PROXY_FEATURE_RAW_SESSIONS ProxyFeature = 1
)

var ProxyFeature_name = map[int32]string{
	0: "PROXY_FEATURE_NONE",
	1: "PROXY_FEATURE_RAW_SESSIONS",
}

var ProxyFeature_value = map[string]int32{
	"PROXY_FEATURE_NONE":         0,
	"PROXY_FEATURE_RAW_SESSIONS": 1,
}

func (x ProxyFeature) String() string {
	return proto.EnumName(ProxyFeature_name, int32(x))
}

func (ProxyFeature) EnumDescriptor() ([]byte, []int) {
...
type DeriveResponseExt struct {
	...
	Codec                Codec                        `protobuf:"varint,5,opt,name=codec,proto3,enum=runtime.Codec" json:"codec,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("runtime.Codec", Codec_name, Codec_value)
	proto.RegisterEnum("runtime.ProxyFeature", ProxyFeature_name, ProxyFeature_value)
...
var fileDescriptor_73af6e0737ce390c = []byte{
	...
	,
}
...
func (m *DeriveResponseExt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Codec != 0 {
		i = encodeVarintRuntime(dAtA, i, uint64(m.Codec))
		i--
		dAtA[i] = 0x28
	}
	if m.Flushed != nil {
...
func (m *ConnectorProxyResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Features != 0 {
		i = encodeVarintRuntime(dAtA, i, uint64(m.Features))
		i--
		dAtA[i] = 0x20
	}
	if m.Log != nil {
...
func (m *ConnectorProxyResponse) ProtoSize() (n int) {
	...
	if m.Features != 0 {
		n += 1 + sovRuntime(uint64(m.Features))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
