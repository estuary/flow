...
type Request_Validate struct {
	...
	NetworkPorts         []*flow.NetworkPort `protobuf:"bytes,8,rep,name=network_ports,json=networkPorts,proto3" json:"network_ports,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
type Response_Spec struct {
	...
	LambdaConfigSchemaJson encoding_json.RawMessage `protobuf:"bytes,3,opt,name=lambda_config_schema_json,json=lambdaConfigSchema,proto3,casttype=encoding/json.RawMessage" json:"lambda_config_schema_json,omitempty"`
...
var fileDescriptor_4410d076c75e1e4f = []byte{
	...
	,
}
...
func (m *Response_Spec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LambdaConfigSchemaJson) > 0 {
		i -= len(m.LambdaConfigSchemaJson)
		copy(dAtA[i:], m.LambdaConfigSchemaJson)
		i = encodeVarintDerive(dAtA, i, uint64(len(m.LambdaConfigSchemaJson)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *Response_Spec) ProtoSize() (n int) {
	...
	l = len(m.LambdaConfigSchemaJson)
	if l > 0 {
		n += 1 + l + sovDerive(uint64(l))
	}
...
func (m *Response_Spec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LambdaConfigSchemaJson", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LambdaConfigSchemaJson = encoding_json.RawMessage(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
