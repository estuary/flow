...
type TransactionRequest_Open struct {
	...
	DriverCheckpointJson encoding_json.RawMessage `protobuf:"bytes,3,opt,name=driver_checkpoint_json,json=driverCheckpoint,proto3,casttype=encoding/json.RawMessage" json:"driver_checkpoint_json,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
var fileDescriptor_3e8b62b327f34bc6 = []byte{
	...
	,
}
