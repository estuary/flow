...
type TransactionRequest_Open struct {
	...
	ShardFqn string `protobuf:"bytes,4,opt,name=shard_fqn,json=shardFqn,proto3" json:"shard_fqn,omitempty"`
...
var fileDescriptor_3e8b62b327f34bc6 = []byte{
	...
	,
}
...
func (m *TransactionRequest_Open) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ShardFqn) > 0 {
		i -= len(m.ShardFqn)
		copy(dAtA[i:], m.ShardFqn)
		i = encodeVarintMaterialize(dAtA, i, uint64(len(m.ShardFqn)))
		i--
		dAtA[i] = 0x22
	}
	if m.Fields != nil {
...
func (m *TransactionRequest_Open) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShardFqn", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ShardFqn = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
