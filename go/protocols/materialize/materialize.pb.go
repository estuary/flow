...
type ValidateRequest struct {
	...
	EndpointSpecJson string `protobuf:"bytes,3,opt,name=endpoint_spec_json,json=endpointSpecJson,proto3" json:"endpoint_spec_json,omitempty"`
	...
	FieldConfigJson      map[string]string `protobuf:"bytes,5,rep,name=field_config_json,json=fieldConfigJson,proto3" json:"field_config_json,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type TransactionRequest_Open struct {
	...
	ShardFqn string `protobuf:"bytes,2,opt,name=shard_fqn,json=shardFqn,proto3" json:"shard_fqn,omitempty"`
...
var fileDescriptor_3e8b62b327f34bc6 = []byte{
	...
	,
}
