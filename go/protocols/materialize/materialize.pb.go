...
const (
	...
	Response_Validated_Constraint_INCOMPATIBLE Response_Validated_Constraint_Type = 6
	...
	Response_Validated_Constraint_UNSATISFIABLE Response_Validated_Constraint_Type = 7
)
...
type Request_Flush struct {
	...
	BackfillBegins       []*Request_Flush_BackfillBegin    `protobuf:"bytes,2,rep,name=backfill_begins,json=backfillBegins,proto3" json:"backfill_begins,omitempty"`
	BackfillCompletes    []*Request_Flush_BackfillComplete `protobuf:"bytes,3,rep,name=backfill_completes,json=backfillCompletes,proto3" json:"backfill_completes,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
type Request_Flush_BackfillBegin struct {
	Binding uint32 `protobuf:"varint,1,opt,name=binding,proto3" json:"binding,omitempty"`
...
func (m *Request_Flush_BackfillBegin) Reset()         { *m = Request_Flush_BackfillBegin{} }
func (m *Request_Flush_BackfillBegin) String() string { return proto.CompactTextString(m) }
func (*Request_Flush_BackfillBegin) ProtoMessage()    {}
func (*Request_Flush_BackfillBegin) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e8b62b327f34bc6, []int{0, 5, 0}
}
func (m *Request_Flush_BackfillBegin) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Request_Flush_BackfillBegin) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Request_Flush_BackfillBegin.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Request_Flush_BackfillBegin) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Request_Flush_BackfillBegin.Merge(m, src)
}
func (m *Request_Flush_BackfillBegin) XXX_Size() int {
	return m.ProtoSize()
}
func (m *Request_Flush_BackfillBegin) XXX_DiscardUnknown() {
	xxx_messageInfo_Request_Flush_BackfillBegin.DiscardUnknown(m)
}

var xxx_messageInfo_Request_Flush_BackfillBegin proto.InternalMessageInfo

// Backfill-complete signals observed during this transaction. See
// BackfillBegin.
type Request_Flush_BackfillComplete struct {
	Binding uint32 `protobuf:"varint,1,opt,name=binding,proto3" json:"binding,omitempty"`
...
func (m *Request_Flush_BackfillComplete) Reset()         { *m = Request_Flush_BackfillComplete{} }
func (m *Request_Flush_BackfillComplete) String() string { return proto.CompactTextString(m) }
func (*Request_Flush_BackfillComplete) ProtoMessage()    {}
func (*Request_Flush_BackfillComplete) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e8b62b327f34bc6, []int{0, 5, 1}
}
func (m *Request_Flush_BackfillComplete) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Request_Flush_BackfillComplete) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Request_Flush_BackfillComplete.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Request_Flush_BackfillComplete) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Request_Flush_BackfillComplete.Merge(m, src)
}
func (m *Request_Flush_BackfillComplete) XXX_Size() int {
	return m.ProtoSize()
}
func (m *Request_Flush_BackfillComplete) XXX_DiscardUnknown() {
	xxx_messageInfo_Request_Flush_BackfillComplete.DiscardUnknown(m)
}

var xxx_messageInfo_Request_Flush_BackfillComplete proto.InternalMessageInfo
...
// needed.
type Response_Validated_ProjectionConstraint struct {
	Field                string                         `protobuf:"bytes,1,opt,name=field,proto3" json:"field,omitempty"`
	Constraint           *Response_Validated_Constraint `protobuf:"bytes,2,opt,name=constraint,proto3" json:"constraint,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}

func (m *Response_Validated_ProjectionConstraint) Reset() {
	*m = Response_Validated_ProjectionConstraint{}
}
func (m *Response_Validated_ProjectionConstraint) String() string { return proto.CompactTextString(m) }
func (*Response_Validated_ProjectionConstraint) ProtoMessage()    {}
func (*Response_Validated_ProjectionConstraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e8b62b327f34bc6, []int{1, 1, 0}
}
func (m *Response_Validated_ProjectionConstraint) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Response_Validated_ProjectionConstraint) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Response_Validated_ProjectionConstraint.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Response_Validated_ProjectionConstraint) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Response_Validated_ProjectionConstraint.Merge(m, src)
}
func (m *Response_Validated_ProjectionConstraint) XXX_Size() int {
	return m.ProtoSize()
}
func (m *Response_Validated_ProjectionConstraint) XXX_DiscardUnknown() {
	xxx_messageInfo_Response_Validated_ProjectionConstraint.DiscardUnknown(m)
}

var xxx_messageInfo_Response_Validated_ProjectionConstraint proto.InternalMessageInfo
...
type Response_Validated_Binding struct {
	...
	CaseInsensitiveFields bool `protobuf:"varint,5,opt,name=case_insensitive_fields,json=caseInsensitiveFields,proto3" json:"case_insensitive_fields,omitempty"`
	...
	ProjectionConstraints []*Response_Validated_ProjectionConstraint `protobuf:"bytes,6,rep,name=projection_constraints,json=projectionConstraints,proto3" json:"projection_constraints,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                                   `json:"-"`
	XXX_unrecognized      []byte                                     `json:"-"`
	XXX_sizecache         int32                                      `json:"-"`
}
...
func (*Response_Validated_Binding) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e8b62b327f34bc6, []int{1, 1, 2}
}
...
type Response_Opened struct {
	...
	DisableLoadOptimization bool     `protobuf:"varint,2,opt,name=disable_load_optimization,json=disableLoadOptimization,proto3" json:"disable_load_optimization,omitempty"`
	XXX_NoUnkeyedLiteral    struct{} `json:"-"`
	XXX_unrecognized        []byte   `json:"-"`
	XXX_sizecache           int32    `json:"-"`
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "materialize.Request.Validate.SecretsEntry")
	...
	proto.RegisterType((*Request_Flush_BackfillBegin)(nil), "materialize.Request.Flush.BackfillBegin")
	proto.RegisterType((*Request_Flush_BackfillComplete)(nil), "materialize.Request.Flush.BackfillComplete")
	...
	proto.RegisterType((*Response_Validated_ProjectionConstraint)(nil), "materialize.Response.Validated.ProjectionConstraint")
...
var fileDescriptor_3e8b62b327f34bc6 = []byte{
	...
	,
}
...
func (m *Request_Validate_Binding) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CollectionIndex != 0 {
		i = encodeVarintMaterialize(dAtA, i, uint64(m.CollectionIndex))
		i--
		dAtA[i] = 0x30
	}
	if len(m.GroupBy) > 0 {
...
func (m *Request_Open) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SealedConfigJson) > 0 {
		i -= len(m.SealedConfigJson)
		copy(dAtA[i:], m.SealedConfigJson)
		i = encodeVarintMaterialize(dAtA, i, uint64(len(m.SealedConfigJson)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.StateJson) > 0 {
...
func (m *Request_Flush) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StatePatchesJson) > 0 {
		i -= len(m.StatePatchesJson)
		copy(dAtA[i:], m.StatePatchesJson)
		i = encodeVarintMaterialize(dAtA, i, uint64(len(m.StatePatchesJson)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Request_Flush_BackfillBegin) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Request_Flush_BackfillBegin) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_Flush_BackfillBegin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_Flush_BackfillComplete) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Request_Flush_BackfillComplete) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_Flush_BackfillComplete) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_Validated_ProjectionConstraint) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Response_Validated_ProjectionConstraint) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_Validated_ProjectionConstraint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Field) > 0 {
		i -= len(m.Field)
		copy(dAtA[i:], m.Field)
		i = encodeVarintMaterialize(dAtA, i, uint64(len(m.Field)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Response_Validated_Binding) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ProjectionConstraints) > 0 {
		for iNdEx := len(m.ProjectionConstraints) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ProjectionConstraints[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Request_Validate_Binding) ProtoSize() (n int) {
	...
	if len(m.FieldConfigJsonMap) > 0 {
		for k, v := range m.FieldConfigJsonMap {
			...
			l = 0
			if len(v) > 0 {
				l = 1 + len(v) + sovMaterialize(uint64(len(v)))
			}
	...
	if m.CollectionIndex != 0 {
		n += 1 + sovMaterialize(uint64(m.CollectionIndex))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Request_Flush_BackfillBegin) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request_Flush_BackfillComplete) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_Validated_ProjectionConstraint) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_Validated_Binding) ProtoSize() (n int) {
	...
	if len(m.ProjectionConstraints) > 0 {
		for _, e := range m.ProjectionConstraints {
			l = e.ProtoSize()
			n += 1 + l + sovMaterialize(uint64(l))
		}
	}
...
func (m *Request_Validate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.LinkedCollections = append(m.LinkedCollections, flow.CollectionSpec{})
...
func (m *Request_Open) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SealedConfigJson", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SealedConfigJson = append(m.SealedConfigJson[:0], dAtA[iNdEx:postIndex]...)
			if m.SealedConfigJson == nil {
				m.SealedConfigJson = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *Request_Load) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.KeyJson = append(m.KeyJson[:0], dAtA[iNdEx:postIndex]...)
			if m.KeyJson == nil {
				m.KeyJson = []byte{}
			}
			iNdEx = postIndex
...
func (m *Request_Flush) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatePatchesJson", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StatePatchesJson = append(m.StatePatchesJson[:0], dAtA[iNdEx:postIndex]...)
			if m.StatePatchesJson == nil {
				m.StatePatchesJson = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.BackfillBegins = append(m.BackfillBegins, &Request_Flush_BackfillBegin{})
		...
		case 3:
			...
			m.BackfillCompletes = append(m.BackfillCompletes, &Request_Flush_BackfillComplete{})
...
func (m *Request_Flush_BackfillBegin) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Request_Flush_BackfillComplete) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Request_Store) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.ValuesJson = append(m.ValuesJson[:0], dAtA[iNdEx:postIndex]...)
			if m.ValuesJson == nil {
				m.ValuesJson = []byte{}
			}
			iNdEx = postIndex
...
func (m *Response_Validated_ProjectionConstraint) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProjectionConstraint: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProjectionConstraint: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.Constraint == nil {
				m.Constraint = &Response_Validated_Constraint{}
			}
...
func (m *Response_Validated_Binding) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CaseInsensitiveFields", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CaseInsensitiveFields = bool(v != 0)
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProjectionConstraints", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProjectionConstraints = append(m.ProjectionConstraints, &Response_Validated_ProjectionConstraint{})
			if err := m.ProjectionConstraints[len(m.ProjectionConstraints)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Response_Opened) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableLoadOptimization", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DisableLoadOptimization = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipMaterialize(dAtA[iNdEx:])
			if err != nil {
