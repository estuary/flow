...
type Request_Validate_Binding struct {
	...
	CollectionIndex      uint32   `protobuf:"varint,4,opt,name=collection_index,json=collectionIndex,proto3" json:"collection_index,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "capture.Request.Discover.SecretsEntry")
	proto.RegisterType((*Request_Validate)(nil), "capture.Request.Validate")
	proto.RegisterMapType((map[string]string)(nil), "capture.Request.Validate.SecretsEntry")
...
var fileDescriptor_841a70e6e6288f13 = []byte{
	...
	,
}
...
func (m *Request_Discover) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Secrets) > 0 {
		for k := range m.Secrets {
			...
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintCapture(dAtA, i, uint64(len(v)))
			i--
			dAtA[i] = 0x12
			i -= len(k)
			copy(dAtA[i:], k)
			i = encodeVarintCapture(dAtA, i, uint64(len(k)))
			i--
			dAtA[i] = 0xa
			i = encodeVarintCapture(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.CreatedAt) > 0 {
		...
		i = encodeVarintCapture(dAtA, i, uint64(len(m.CreatedAt)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Name) > 0 {
...
func (m *Request_Validate_Binding) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CollectionIndex != 0 {
		i = encodeVarintCapture(dAtA, i, uint64(m.CollectionIndex))
		i--
		dAtA[i] = 0x20
	}
	if m.Backfill != 0 {
...
func (m *Request_Open) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SealedConfigJson) > 0 {
		...
		i = encodeVarintCapture(dAtA, i, uint64(len(m.SealedConfigJson)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.StateJson) > 0 {
...
func (m *Request_Discover) ProtoSize() (n int) {
	...
	if len(m.Secrets) > 0 {
		for k, v := range m.Secrets {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovCapture(uint64(len(k))) + 1 + len(v) + sovCapture(uint64(len(v)))
			n += mapEntrySize + 1 + sovCapture(uint64(mapEntrySize))
		}
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *Request_Validate_Binding) ProtoSize() (n int) {
	...
	if m.CollectionIndex != 0 {
		n += 1 + sovCapture(uint64(m.CollectionIndex))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
