...
func TestPartitionPicking(t *testing.T) {
	...
	for ind, tc := range []struct {
		...
		{"a/collection/00ffffffffffffff/bar=%_32/foo=A/", "b9f08d38"},
		{"a/collection/00ffffffffffffff/bar=%_32/foo=A/", "1505e3cb"},
		{"a/collection/00ffffffffffffff/bar=%_42/foo=A%2FB/", "b9f08d38"},
	} {
