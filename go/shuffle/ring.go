...
func (r *ring) serve() {
	...
	r.log(ops.DebugLevel, "started shuffle ring")
...
loop:
	...
	r.log(ops.DebugLevel, "stopped shuffle ring")
}

func (r *ring) log(lvl ops.Level, message string, extra ...interface{}) {
